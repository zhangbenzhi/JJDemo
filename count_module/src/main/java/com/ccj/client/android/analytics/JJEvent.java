...
public final class JJEvent {
     ...
     */
    public static void trackClick(String ec, String ea, String el) {
        trackClick(ec, ea, el, null);
    }
     ...
     * @param ecp event custom Parameters 自定义参数Map<key,value>
     */
    public static void trackClick(String ec, String ea, String el, Map ecp) {
        try {
     ...
     * @param ecp      event custom Parameters 自定义参数Map<key,value>
     */
    public static synchronized void trackExpose(String exposeID, String ec, String ea, Map ecp) {
        try {
